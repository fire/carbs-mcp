...
**Status:** Accepted **Date:** 2025-01-09 **Context:** Pythonx doesn't easily
persist Python object references across eval calls. Need to manage CARBS
instance state.

**Decision:** Serialize CARBS state to base64 string, deserialize for each
operation, re-serialize after updates
