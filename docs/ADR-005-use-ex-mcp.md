...
**Status:** Accepted  
**Date:** 2025-01-09  
**Context:** Need to implement MCP stdio server. Options include ex_mcp library or implementing from scratch.

**Decision:** Use ex_mcp library from GitHub (https://github.com/azmaveth/ex_mcp)
